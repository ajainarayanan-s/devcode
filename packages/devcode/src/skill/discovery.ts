...
import { httpClient, path } from "@devcode/core/effect/layer-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@devcode/SkillDiscovery") {}
