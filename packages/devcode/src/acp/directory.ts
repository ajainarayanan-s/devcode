...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@devcode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@devcode/ACPDirectory") {}
