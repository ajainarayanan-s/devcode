...
import { PermissionV1 } from "@devcode/core/v1/permission"
import { Slug } from "@devcode/core/util/slug"
import { SessionV1 } from "@devcode/core/v1/session"
import { serviceUse } from "@devcode/core/effect/service-use"
import path from "path"
import { BackgroundJob } from "@/background/job"
import { Decimal } from "decimal.js"
import type { ProviderMetadata, Usage } from "@devcode/llm"
...
import { PartTable, SessionTable } from "@devcode/core/session/sql"
...
import { NonNegativeInt, optionalOmitUndefined } from "@devcode/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".devcode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@devcode/Session") {}
