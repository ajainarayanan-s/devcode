import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@devcode/llm"
...
// Move this extraction into @devcode/llm when Copilot is handled by the native runtime.
