import type { JsonSchema, LLMRequest, ProviderMetadata } from "@devcode/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@devcode/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @devcode/llm request objects from devcode's session/AI SDK-shaped data.
  return LLM.request({
