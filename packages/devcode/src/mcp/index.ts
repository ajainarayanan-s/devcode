...
import { ConfigMCPV1 } from "@devcode/core/v1/config/mcp"
...
const CLIENT_OPTIONS = {
  capabilities: {
    // https://github.com/anomalyco/devcode/issues/11948
    // sampling: {},
    // https://github.com/anomalyco/devcode/issues/23066
    // elicitation: {},
    // https://github.com/anomalyco/devcode/issues/2308
    roots: {},
    // https://github.com/anomalyco/devcode/issues/28567
    // tasks: {},
  },
...
function createClient(directory: string) {
  const client = new Client({ name: "devcode", version: InstallationVersion }, CLIENT_OPTIONS)
...
export class Service extends Context.Service<Service, Interface>()("@devcode/MCP") {}
            ...
            if (isAuthError) {
              if (lastError.message.includes("registration") || lastError.message.includes("client_id")) {
                ...
                return events
                  .publish(TuiEvent.ToastShow, {
                    title: "MCP Authentication Required",
                    message: `Server "${key}" requires authentication. Run: devcode mcp auth ${key}`,
                    variant: "warning",
                    duration: 8000,
                  })
                  .pipe(Effect.ignore, Effect.as(undefined))
