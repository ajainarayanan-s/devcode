...
>()("@devcode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@devcode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.DEVCODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.DEVCODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-devcode-directory"] || process.cwd()
}
