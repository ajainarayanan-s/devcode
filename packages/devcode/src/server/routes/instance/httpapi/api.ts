...
export const RootHttpApi = HttpApi.make("devcode-root")
...
export const InstanceHttpApi = HttpApi.make("devcode-instance")
...
export const OpenCodeHttpApi = HttpApi.make("devcode")
