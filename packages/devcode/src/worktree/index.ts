...
import { path } from "@devcode/core/effect/layer-node-platform"
...
import type { ProjectV2 } from "@devcode/core/project"
...
export class Service extends Context.Service<Service, Interface>()("@devcode/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `devcode/${name}`
