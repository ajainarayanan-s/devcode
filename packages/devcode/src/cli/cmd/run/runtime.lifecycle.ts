...
import { openEditor } from "@devcode/tui/editor"
import { registerDevcodeKeymap } from "@devcode/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerDevcodeKeymap(keymap, renderer, input.tuiConfig)
