...
//
// The saved variant persists across sessions in ~/.local/state/devcode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@devcode/RunVariant") {}
