...
import type { Event, GlobalEvent, OpencodeClient } from "@devcode/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@devcode/RunStreamTransport") {}
