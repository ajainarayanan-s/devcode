 ...
 *   "@devcode/ServerAuthConfig",
 *   {
 *     password: Config.string("DEVCODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("DEVCODE_SERVER_USERNAME").pipe(Config.withDefault("devcode")),
 *   },
 * ) {}
 *
