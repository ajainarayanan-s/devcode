...
import { EventSequenceTable, EventTable } from "@devcode/core/event/sql"
...
export class Service extends Context.Service<Service, Interface>()("@devcode/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        DEVCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        DEVCODE_WORKSPACE_ID: config.id,
        DEVCODE_EXPERIMENTAL_WORKSPACES: "true",
