...
import type * as SDK from "@devcode/sdk/v2"
...
import { SessionShareTable } from "@devcode/core/share/sql"
import { ProviderV2 } from "@devcode/core/provider"
import { ModelV2 } from "@devcode/core/model"
import { EventV2 } from "@devcode/core/event"

const disabled = process.env["DEVCODE_DISABLE_SHARE"] === "true" || process.env["DEVCODE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@devcode/ShareNext") {}
