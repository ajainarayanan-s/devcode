...
export class Service extends Context.Service<Service, Interface>()("@devcode/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __DEVCODE_PHOTON_WASM_PATH?: string }).__DEVCODE_PHOTON_WASM_PATH =
