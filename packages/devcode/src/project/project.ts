...
import { ProjectDirectoryTable, ProjectTable } from "@devcode/core/project/sql"
...
import { which } from "@devcode/core/util/which"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@devcode/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@devcode/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.DEVCODE_FAKE_VCS)
