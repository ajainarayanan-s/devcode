...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/devcode.git")).toEqual({ owner: "sst", repo: "devcode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/devcode")).toEqual({ owner: "sst", repo: "devcode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/devcode.git")).toEqual({ owner: "sst", repo: "devcode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/devcode")).toEqual({ owner: "sst", repo: "devcode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/devcode.git")).toEqual({ owner: "sst", repo: "devcode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/devcode")).toEqual({ owner: "sst", repo: "devcode" })
})
