...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders DEVCODE_CALLER", () => {
    process.env["DEVCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode DEVCODE_CALLER", () => {
    process.env["DEVCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown DEVCODE_CALLER", () => {
    process.env["DEVCODE_CALLER"] = "unknown"
