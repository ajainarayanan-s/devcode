...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips devcode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-devcode-directory"]).toBeUndefined()
      expect(forwarded["x-devcode-workspace"]).toBeUndefined()
