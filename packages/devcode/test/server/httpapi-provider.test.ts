...
function writeProviderAuthPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* Effect.promise(() => markPluginDependenciesReady(path.join(dir, ".devcode")))

    yield* fs.writeWithDirs(
      path.join(dir, ".devcode", "plugin", "provider-oauth-parity.ts"),
      [
        "export default {",
...
function writeProviderAuthValidationPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* fs.writeWithDirs(
      path.join(dir, ".devcode", "plugin", "provider-oauth-validation.ts"),
      [
        "export default {",
...
function writeFunctionOptionsPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* fs.writeWithDirs(
      path.join(dir, ".devcode", "plugin", "provider-function-options.ts"),
      [
        "export default {",
...
function writeProviderModelsMutationPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* fs.writeWithDirs(
      path.join(dir, ".devcode", "plugin", "provider-models-mutation.ts"),
      [
        "export default {",
...
describe("provider HttpApi", () => {
  it.instance.skip(
    ...
    Effect.gen(function* () {
      ...
      const response = yield* request("/api/provider/missing", {
        headers: { "x-devcode-directory": directory },
      })
  ...
  it.instance(
    ...
    Effect.gen(function* () {
      const directory = (yield* TestInstance).directory
      const headers = { "x-devcode-directory": directory, "content-type": "application/json" }
  ...
  it.instance(
    ...
    Effect.gen(function* () {
      ...
      const response = yield* requestAuthorize({
        ...
        method: 0,
        inputs: { token: "nope" },
        headers: { "x-devcode-directory": directory, "content-type": "application/json" },
      })
  ...
  it.instance(
    ...
    Effect.gen(function* () {
      ...
      const headers = { "x-devcode-directory": directory }
