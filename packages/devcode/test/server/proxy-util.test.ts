...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips devcode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-devcode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-devcode-directory")).toBeNull()
      expect(result.get("x-devcode-workspace")).toBeNull()
