...
- Effect plugins import `@devcode/plugin/v2/effect`, not `@devcode/core`.
- Public domain values use generated `@devcode/sdk` types.
...
- Define `PluginHost` domain capabilities in `@devcode/plugin/v2/effect`.
