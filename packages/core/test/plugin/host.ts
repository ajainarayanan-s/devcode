import type { AISDKHooks, PluginHost } from "@devcode/plugin/v2/effect"
...
import type { IntegrationEnvMethod, IntegrationKeyMethod, IntegrationOAuthMethod } from "@devcode/sdk/v2/types"
