...
import type { EffectDrizzleSqlite } from "@devcode/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@devcode/ProjectDirectories") {}
