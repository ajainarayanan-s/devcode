...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@devcode/llm"
...
export class Service extends Context.Service<Service, Interface>()("@devcode/v2/ToolRegistry") {}
