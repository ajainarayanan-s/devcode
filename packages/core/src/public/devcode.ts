export * as DevCode from "./devcode"
...
/** Intentional public native API for Effect applications embedding DevCode. */
export class Service extends Context.Service<Service, Interface>()("@devcode/public/DevCode") {}
...
>()("@devcode/public/DevCode/SessionModelValidation") {}
...
const SessionModelValidationLayer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    return SessionModelValidation.of({
      validate: Effect.fn("DevCode.sessions.validateModel")(function* (input) {
  ...
  Effect.gen(function* () {
    ...
    return Service.of({
      ...
      sessions: {
        ...
        get: sessions.get,
        list: sessions.list,
        switchModel: Effect.fn("DevCode.sessions.switchModel")(function* (input) {
...
// TODO: Add DevCode.create(...) as the Promise facade over the same native API semantics.
