...
export class RequestContextRef extends Context.Service<RequestContextRef, RequestContext>()(
  "@devcode/example/RequestContextRef",
) {}
...
export class ConfigServiceMap extends LayerMap.Service<ConfigServiceMap>()("@devcode/example/ConfigServiceMap", {
