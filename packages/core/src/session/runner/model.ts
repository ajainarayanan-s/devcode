...
import { type Model } from "@devcode/llm"
import * as AnthropicMessages from "@devcode/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@devcode/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@devcode/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@devcode/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@devcode/v2/SessionRunnerModel") {}
