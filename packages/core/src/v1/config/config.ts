...
export const Info = Schema.Struct({
  ...
  server: Schema.optional(ConfigServerV1.Server).annotate({
    description: "Server configuration for devcode serve and web commands",
  }),
  command: Schema.optional(Schema.Record(Schema.String, ConfigCommandV1.Info)).annotate({
    description: "Command configuration, see https://devcode.ai/docs/commands",
  }),
  ...
  ).annotate({ description: "Agent configuration, see https://devcode.ai/docs/agents" }),
