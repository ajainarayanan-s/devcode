...
export class Service extends Context.Service<Service, Interface>()("@devcode/v2/FileSystem/Search") {}
...
export const defaultLayer = Layer.unwrap(
  Effect.sync(() => (Flag.DEVCODE_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)),
)
