...
declare const DEVCODE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof DEVCODE_LIBC === "undefined" ? undefined : DEVCODE_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@devcode/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.DEVCODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.DEVCODE_EXPERIMENTAL_FILEWATCHER) {
