...
const docs = `### Overview
Line comment **display** and **editor** cards aligned with DevCode line-comment specs (raised \`#FAFAFA\` surface, footer line context, \`ButtonV2\` neutral + contrast actions).
