...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "DEVCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/devcode/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/devcode (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/devcode/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/devcode/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const DEVCODE_DB|DEVCODE_DB|DEVCODE_DEV|Global\\.Path\\.data|data =" in packages/devcode/src (115 matches)',
  },
] as const
