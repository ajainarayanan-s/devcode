...
import defaultSoundPath from "@devcode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@devcode/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@devcode/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@devcode/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@devcode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@devcode/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "devcode"
const DEFAULT_PACK_ID = "devcode.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "DevCode Default",
  builtin: true,
  sounds: {
