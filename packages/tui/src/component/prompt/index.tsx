...
import type { AssistantMessage, FilePart, UserMessage } from "@devcode/sdk/v2"
...
import { DEVCODE_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useDevcodeKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.DEVCODE_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
