...
Schema-first LLM core for devcode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@devcode/llm"
import { OpenAI } from "@devcode/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@devcode/llm/providers"
