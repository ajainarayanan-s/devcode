...
class Database extends Context.Service<Database, DatabaseShape>()("@devcode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@devcode/example/UserStore") {
