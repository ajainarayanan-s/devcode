...
export const TypeId: TypeId = "~@devcode/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@devcode/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@devcode/effect-sqlite-node/NodeSqliteClient")
